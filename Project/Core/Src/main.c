...
#define REFERENCE_VOLTAGE 1.6f
#define NUM_INTERVALS     8

// Si quieres que sea variable en tiempo de ejecución:
// static float referenceVoltage = 2.5f;
...
/* Variables globales */
volatile uint8_t adc_task_active = 0; // Bandera para controlar el estado de la tarea (1 = activa, 0 = inactiva)
volatile uint32_t debounce_time = 0;  // Tiempo para el filtro de rebote


/* Declaración del handle de la tarea */
